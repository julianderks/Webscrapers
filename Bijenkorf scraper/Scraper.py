# ALL ARTICLES
# data = "query { productListing(query: \"\"\"fh_location=//catalog01/nl_NL/categories<{catalog01}&fh_start_index=0&fh_view_size=2&country=NL&chl=1&vt=unknown\"\"\", locale: \"nl-NL\") { \n    navigation {\n        products {\n            \n    brand {\n        \n    name\n\n    }\n    code\n    colorCount\n    currentVariantProduct {\n        \n    availability {\n        \n    available\n    availableFuture\n    stock\n\n    }\n    code\n    color\n    current\n    images {\n        \n    position\n    type\n    url\n\n    }\n    overriddenPrices {\n        \n    currencyCode\n    type\n    value\n\n    }\n    sellingPrice {\n        \n    currencyCode\n    type\n    value\n\n    }\n    signings {\n        \n    discount {\n        \n    key\n    text\n\n    }\n    merchandise {\n        \n    key\n    text\n\n    }\n\n    }\n    trackingMetadata\n    size\n    url\n\n    }\n    defaultVariantCode\n    description\n    designer\n    displayName\n    displayProperties {\n        \n    currentVariantSelected\n    detailPageVariation\n\n    }\n    gift\n    name\n    subBrand {\n        \n    name\n\n    }\n    supplierModel\n    sustainable\n    trackingMetadata\n    url\n    variantProducts (limit:4, groupBy: COLOR) {\n        \n    availability {\n        \n    available\n    availableFuture\n    stock\n\n    }\n    code\n    color\n    current\n    images {\n        \n    position\n    type\n    url\n\n    }\n    overriddenPrices {\n        \n    currencyCode\n    type\n    value\n\n    }\n    sellingPrice {\n        \n    currencyCode\n    type\n    value\n\n    }\n    signings {\n        \n    discount {\n        \n    key\n    text\n\n    }\n    merchandise {\n        \n    key\n    text\n\n    }\n\n    }\n    trackingMetadata\n    size\n    url\n\n    }\n    recommendationRanking\n\n        }\n        pagination {\n            \n    currentPage {\n        \n    pageNumber\n    query\n    relativeUrl\n\n    }\n    nextPage {\n        \n    pageNumber\n    query\n    relativeUrl\n\n    }\n    previousPage {\n        \n    pageNumber\n    query\n    relativeUrl\n\n    }\n    totalItemCount\n    viewSize\n\n        }\n    }\n } }"
import requests
import pprint
import pandas as pd
...
def query_article(productCode, productVariantCode, productReferer):
  headers = {
    'authority': 'ceres-catalog.debijenkorf.nl',
    'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.135 Safari/537.36',
    'accept': '*/*',
    'origin': 'https://www.debijenkorf.nl',
  ...
  ('productCode', '0014012163'),
  ('productVariantCode', '001401216800000'),
...
# herenKLEDING categories<{catalog01_80_890}
# vrouwenKLEDING categories<{catalog01_60_880}

# brand>{america_today}

MenQuery = baseQuery.replace('**CATEGORYPLACEHOLDER**', 'brand>{america_today}/categories<{catalog01_80}')
WomenQuery = baseQuery.replace('**CATEGORYPLACEHOLDER**', 'brand>{america_today}/categories<{catalog01_60}')
BoysQuery = baseQuery.replace('**CATEGORYPLACEHOLDER**', 'brand>{america_today}/categories<{catalog01_100}/baby_geslacht>{jongens}')
GirlsQuery = baseQuery.replace('**CATEGORYPLACEHOLDER**', 'brand>{america_today}/categories<{catalog01_100}/baby_geslacht>{meisjes}')
...
for targetgroup, basequery in zip(['Men', 'Women', 'Boys', 'Girls'], [MenQuery, WomenQuery, BoysQuery, GirlsQuery]):
    index = 0
    artnr = 0
    # Keep quering next productlists until you receive an empty list.
    while (True):
        # Replace the indexvariable in the query string
        query = basequery.replace('**INDEXPLACEHOLDER**', f'fh_start_index={index}')
        ...
        for data in productList:
            ...
            # Random wait times to simulate a real user instead of webscraper
...
df.to_csv(f"BijenkorfData {date.today()}.csv")

print("\n Skipped, could not follow link..")
for name in skipped:
    print(name)